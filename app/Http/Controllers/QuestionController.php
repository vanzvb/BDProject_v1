...
class QuestionController extends Controller
{
    ...
    {
        $followupQuestions = Question::whereNull('followup_question_id')->get();

    return view('questions.create', compact('followupQuestions'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'followup_question_id' => 'nullable|exists:followup_questions,id', // Assuming you have a followup_questions table
            'followup_question_text' => 'nullable|string|max:255',
        ]);
    ...
    public function update(Request $request, Question $question)
    {
        $request->validate([
            ...
            'is_mandatory' => 'nullable|boolean', // Change to nullable
            'order' => 'nullable|integer',
            'followup_question_id' => 'nullable|exists:followup_questions,id',
            'followup_question_text' => 'nullable|string|max:255',
        ]);
