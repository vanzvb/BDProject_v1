    ...
    <head>
        ...
        <style>
            ...
            .muted {
                ...
                opacity: 0.5;
                /* Optional: make the row slightly transparent */
                text-decoration: line-through;
                /* Optional: add a strikethrough effect */
            }
        </style>
    </head>
        ...
        <div class="container mt-5">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><strong>My Profile</strong></h3>
                </div>
                            ...
                            <tbody>
                                @foreach ($events as $event)
                                    <tr>
                                        ...
                                        <td>{{ $event->detail }}</td>
                                        <td>
                                            <a href="{{ route('newform.show', ['event_id' => $event->id]) }}"
                                                class="btn btn-primary">Go to New Form</a>
