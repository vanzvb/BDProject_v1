                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    @elseif($question->type == 'radio')
                                        <div>
                                            <input type="radio" name="question_{{ $question->id }}" value="yes" disabled> Yes
                                            <input type="radio" name="question_{{ $question->id }}" value="no" disabled> No
                                        </div>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="confirmation" name="confirmation" disabled>
